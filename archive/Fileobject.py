...
from datastructures.FileInfo import FileInfo
import os
import numpy as np
from autoactive.Folder import Folder
...
class Fileobject(Dataobject):
    ...
    def toSerializable(self, **kwargs):
        ...
        kwargs['archiveWriter'].writeCopyContentFromFile(file_detailts['user']['folder'] + '\\'
                                                         + file_detailts['user']['name'], kwargs['uuid'] + path)
